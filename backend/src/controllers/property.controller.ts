...
const getAllProperties = asyncHandler(async (_: Request, res: Response): Promise<Response> => {
...
const getPropertyById = asyncHandler(async (req: Request, res: Response): Promise<Response>  => {
  const { id } = req.params;
